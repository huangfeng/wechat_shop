            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            ...
                            <td>
                                <img width="100px" height="70px;" src="${productInfo.productIcon}" alt="">
                            </td>
                            <td>
                            ...
                            <td>
                                <#if productInfo.getProductStatusEnmu().msg == "在架">
                ...
                <div class="col-md-12 column">
                    ...
                    <#list 1..productInfoPage.getTotalPages() as index>
                        ...
                        <#else >
                            <li>
                                <a href="/sell/seller/product/list?page=${index}&size=${orderMasterDTOPage.getSize()}">${index}</a>
                            </li>
                        </#if>
                    </#list>
